...
// The LRU we've been using. It's called 2Q because there is a main queue and
// tail queue, marginal-hits needs the tail queue
*/
#pragma once
 ...
 * we chain 2 queues: hot -> hot_tail 
 * 
 * hot_tail represents the last slab of items, for estimating mrc gradient
 * 
 */
class MMSimple2Q {
 public:
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
MMSimple2Q::Container<T, HookPtr>::Container(const serialization::MM2QObject& object,
                                       PtrCompressor compressor)
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
bool MMSimple2Q::Container<T, HookPtr>::recordAccess(T& node,
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
cachelib::EvictionAgeStat MMSimple2Q::Container<T, HookPtr>::getEvictionAgeStat(
    uint64_t projectedLength) const noexcept {
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
cachelib::EvictionAgeStat MMSimple2Q::Container<T, HookPtr>::getEvictionAgeStatLocked(
    uint64_t projectedLength) const noexcept {
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
uint32_t MMSimple2Q::Container<T, HookPtr>::getOldestAgeLocked(
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
typename MMSimple2Q::LruType MMSimple2Q::Container<T, HookPtr>::getLruType(
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
void MMSimple2Q::Container<T, HookPtr>::rebalance() noexcept {
  // adjust tail sizes
  adjustTail(LruType::Hot);
}

template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
bool MMSimple2Q::Container<T, HookPtr>::add(T& node) noexcept {
  const auto currTime = static_cast<Time>(util::getCurrentTimeSec());
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
typename MMSimple2Q::Container<T, HookPtr>::LockedIterator
MMSimple2Q::Container<T, HookPtr>::getEvictionIterator() const noexcept {
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
template <typename F>
void MMSimple2Q::Container<T, HookPtr>::withEvictionIterator(F&& fun) {
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
template <typename F>
void MMSimple2Q::Container<T, HookPtr>::withContainerLock(F&& fun) {
  lruMutex_->lock_combine([&fun]() { fun(); });
}

template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
void MMSimple2Q::Container<T, HookPtr>::removeLocked(T& node,
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
void MMSimple2Q::Container<T, HookPtr>::setConfig(const Config& newConfig) {
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
typename MMSimple2Q::Config MMSimple2Q::Container<T, HookPtr>::getConfig() const {
  return lruMutex_->lock_combine([this]() { return config_; });
}

template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
bool MMSimple2Q::Container<T, HookPtr>::remove(T& node) noexcept {
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
void MMSimple2Q::Container<T, HookPtr>::remove(Iterator& it) noexcept {
  T& node = *it;
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
bool MMSimple2Q::Container<T, HookPtr>::replace(T& oldNode, T& newNode) noexcept {
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
MMSimple2Q::LruType MMSimple2Q::Container<T, HookPtr>::getTailLru(LruType list) const {
  switch (list) {
  case LruType::Hot:
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
void MMSimple2Q::Container<T, HookPtr>::adjustTail(LruType list) {
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
serialization::MM2QObject MMSimple2Q::Container<T, HookPtr>::saveState()
    const noexcept {
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
MMContainerStat MMSimple2Q::Container<T, HookPtr>::getStats() const noexcept {
  return lruMutex_->lock_combine([this]() {
    ...
    auto hotSize = lru_.getList(LruType::Hot).size();
    auto hotTailSize = lru_.getList(LruType::HotTail).size();
    auto coldSize = lru_.getList(LruType::Cold).size();
    auto coldTailSize = lru_.getList(LruType::ColdTail).size();

    uint64_t numTailAccess = numHotTailAccesses_;

    XLOGF(DBG,
          "Simple2Q stats: hot size: {}, hot tail size: {}, cold size: {}, cold tail size: {}",
          hotSize, hotTailSize,
          coldSize, coldTailSize);
    
    XLOGF(DBG,
          "Simple2Q stats: hot accesses: {}, cold accesses: {}, warm accesses: {}, "
          "hot tail accesses: {}, warm tail accesses: {}, cold tail accesses: {}",
          numHotAccesses_, numColdAccesses_, numWarmAccesses_,
          numHotTailAccesses_, numWarmTailAccesses_, numColdTailAccesses_);
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
void MMSimple2Q::Container<T, HookPtr>::reconfigureLocked(const Time& currTime) {
...
template <typename T, MMSimple2Q::Hook<T> T::* HookPtr>
MMSimple2Q::Container<T, HookPtr>::LockedIterator::LockedIterator(
