...
MarginalHitsStrategyOld::MarginalHitsStrategyOld(Config config)
    : RebalanceStrategy(MarginalHits), config_(std::move(config)) {}

RebalanceContext MarginalHitsStrategyOld::pickVictimAndReceiverImpl(
...
ClassId MarginalHitsStrategyOld::pickVictimImpl(const CacheBase& cache,
                                             PoolId pid,
...
MarginalHitsStrategyOld::computeClassMarginalHits(PoolId pid,
...
RebalanceContext MarginalHitsStrategyOld::pickVictimAndReceiverFromRankings(
    PoolId pid,
